...
# Note: Environment variables use karein ya manually enter karein
BOT_TOKEN = os.environ.get("PANEL_BOT_TOKEN") or input("Enter Telegram Bot Token: ").strip()
ADMIN_ID = int(os.environ.get("PANEL_ADMIN_ID") or input("Enter Admin Telegram ID: ").strip())
...
def send_otp(tg_id):
    ...
    OTP_CACHE[tg_id] = otp
    try:
        tg.send_message(tg_id, f"🛡️ **KAALIX SECURITY**\n\nYour Login OTP: `{otp}`\n\nDon't share this code.")
...
# Modern Glassmorphism CSS & Header
BASE_HEAD = """
...
if __name__ == "__main__":
    ...
    print(f"Panel running on http://localhost:{PORT}")
